...
**【地理现实 · 人地互动常识】**（构建自然 / 人文环境时务必遵循，除非「世界规则」明确要求架空突破）：
- **聚落随水而生**：大河流域、湖畔、河口、海岸、绿洲是人口与城镇的聚集地，文明多发源于此；远离水源的内陆腹地人烟稀少。
- **地形决定密度**：平原、温带河谷宜农耕、人口稠密、易成大城；沙漠、极地、高山、密林地广人稀，仅在绿洲 / 河谷 / 矿脉等局部聚居。
- **要冲成重镇**：关隘、渡口、山口、港口、商路交汇处天然形成军事重镇与商业枢纽。
- **气候塑造文明**：寒带多游牧渔猎，温带多农耕定居，热带 / 干旱区各有形态；物产、人口、城邦规模随气候与资源梯度变化，不会均匀分布。
- **山河即边界**：大山脉、宽阔江河、海峡常成为势力、国家、文化的天然分界。
- 据此让「地理 → 资源 → 人口 → 城池 → 势力」形成自洽链条，避免"沙漠中心建超级都市""无水之地遍布村镇"等反常识设定。{{#if worldRulesContext}}
...
- **遵循人地互动常识**（除非该世界规则要求架空突破）：聚落随水而生（大河 / 海岸 / 绿洲聚人成城），平原温带人口稠密、沙漠极地地广人稀，关隘渡口港口成重镇，气候资源决定人口与城邦分布，山河成天然边界——让「地理→资源→人口→城池→势力」自洽，杜绝反常识布局。
