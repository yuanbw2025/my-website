...
本仓库（`yuanbw2025/ai-presentation`）是 **开发正本**，所有日常开发、功能迭代、bug 修复都在此仓库进行。
...
- **Vercel**：自动部署，线上地址 `https://yuanbw.vercel.app/ai-presentation/`
...
```bash
cd ~/Desktop/projects/ai-presentation
